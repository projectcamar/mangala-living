...
export default async function handler(
  ...
  const { firstName, email, whatsapp, notificationType, productName, productSlug, productPrice, productCategory, productUrl, firstMessage, language } = req.body;

  // For order_now notifications, firstName and email are optional (can be 'Visitor' and 'unknown@email.com')
  // For catalog_download and chatbot_lead, they are required
  ...
  if ((isCatalogDownload || isChatbotLead) && (!firstName || !email)) {
