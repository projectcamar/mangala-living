    ...
    <div style={{ display: 'none' }} aria-hidden="true">
      ...
      <p>
        {isIndonesian 
          ...
          : "Mangala Living is a trusted industrial steel custom furniture manufacturer in Bekasi since 1999. With 25+ years of experience, we have served more than 1,000 businesses throughout Indonesia."
        }
      </p>
      ...
      <ul>
        ...
        <li>✓ {isIndonesian ? "1000+ klien puas di seluruh Indonesia" : "1000+ satisfied clients throughout Indonesia"}</li>
        ...
        <li>✓ {isIndonesian ? "Pengiriman ke seluruh Indonesia" : "Shipping throughout Indonesia"}</li>
      ...
      <p>
        {isIndonesian 
          ? "Beberapa produk unggulan kami meliputi Frame Loft Bookshelf, Balcony Bar Table, Beam Industrial Bar Chair, Industrial Kitchen Cabinet, dan berbagai furniture custom lainnya. Semua produk dapat disesuaikan dengan kebutuhan dan budget Anda."
          : "Some of our featured products include Frame Loft Bookshelf, Balcony Bar Table, Beam Industrial Bar Chair, Industrial Kitchen Cabinet, and various other custom furniture. All products can be customized according to your needs and budget."
        }
      </p>
      ...
      <p>
        <strong>{isIndonesian ? "WhatsApp/Telp:" : "WhatsApp/Phone:"}</strong> +62 852-1207-8467 | 
