...
const showroomImage = '/images/products/Bench-corner-kursi-sudut-kursi-santai.webp'
const logoILW = '/images/products/LOGO-ILW-800.png'
const logoSVLK = '/images/products/SVLK-LOGO-INDONESIA.png'
