...
const projectVideo = '/images/products/meja-makan-industrial.mp4'
const experienceImage = '/images/products/Hollowline-Display-Rack.webp'
const collaborationImage = '/images/products/Meja-Kerja-Rak-Meja-Belajar-custom.webp'
const flexibilityImage = '/images/products/Kabinet-Industrial-Dapur.webp'
const scaleImage = '/images/products/Meja-makan-industrial-150x60x90-2 kursi.webp'
