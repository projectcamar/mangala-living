...
Sempurna untuk lounge, area tunggu, hotel, dan ruang komersial, rangka daybed industrial ini menyediakan kapasitas tempat duduk dan relaksasi yang serbaguna. Desain daybed menawarkan opsi tempat duduk dan berbaring yang nyaman untuk tamu dan pelanggan.`,
    ...
    ar: { name: 'إطار سرير نهاري صناعي', caption: 'إطار سرير نهاري صناعي - إطار سرير نهاري فولاذي لمناطق الصالة | Mangala Living', shortCaption: 'إطار سرير نهاري صناعي - سرير نهاري فولاذي', description: `إطار السرير النهاري الصناعي من Mangala Living هو الحل المثالي للأثاث الصناعي للمساحات الحديثة. يتميز إطار السرير النهاري الصناعي المميز هذا بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من المتانة والجاذبية البصرية.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض إطار السرير النهاري الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي قوة ممتازة مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالي للصالات ومناطق الانتظار والفنادق والمساحات التجارية، يوفر إطار السرير النهاري الصناعي هذا قدرات جلوس واسترخاء متعددة الاستخدامات. يوفر تصميم السرير النهاري خيارات جلوس واسترخاء مريحة للضيوف والعملاء.`, metaDescription: 'إطار سرير نهاري صناعي - إطار سرير نهاري فولاذي | أثاث الصالة | Mangala Living', imageAlt: 'إطار سرير نهاري صناعي - سرير نهاري فولاذي - أثاث مميز من Mangala Living' },
    zh: { name: '工业躺椅框架', caption: '工业躺椅框架 - 休息区用钢制躺椅框架 | Mangala Living', shortCaption: '工业躺椅框架 - 钢制躺椅', description: `Mangala Living的工业躺椅框架是现代空间的完美工业家具解决方案。这款优质工业躺椅框架采用坚固的工业设计和钢结构，提供最大的耐用性和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业躺椅框架展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的强度，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合休息室、等候区、酒店和商业空间，这款工业躺椅框架提供多功能座椅和休息能力。躺椅设计为客人和顾客提供舒适的座椅和休息选项。`, metaDescription: '工业躺椅框架 - 钢制躺椅框架 | 休息室家具 | Mangala Living', imageAlt: '工业躺椅框架 - 钢制躺椅 - Mangala Living的优质家具' },
    ja: { name: 'インダストリアル デイベッドフレーム', caption: 'インダストリアル デイベッドフレーム - ラウンジエリア用スチールデイベッドフレーム | Mangala Living', shortCaption: 'インダストリアル デイベッドフレーム - スチールデイベッド', description: `Mangala Livingのインダストリアル デイベッドフレームは、モダンな空間のための完璧な工業用家具ソリューションです。このプレミアム工業用デイベッドフレームは、最大限の耐久性と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用デイベッドフレームは、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた強度を提供します。\n\nラウンジ、待合エリア、ホテル、商業空間に最適で、この工業用デイベッドフレームは多目的な座席とリラクゼーション機能を提供します。デイベッドデザインは、ゲストや顧客に快適な座席とラウンジオプションを提供します。`, metaDescription: 'インダストリアル デイベッドフレーム - スチールデイベッドフレーム | ラウンジ家具 | Mangala Living', imageAlt: 'インダストリアル デイベッドフレーム - スチールデイベッド - Mangala Livingのプレミアム家具' },
    es: { name: 'Marco de Diván Industrial', caption: 'Marco de Diván Industrial - Marco de Diván de Acero para Áreas de Lounge | Mangala Living', shortCaption: 'Marco de Diván Industrial - Diván de Acero', description: `El Marco de Diván Industrial de Mangala Living es la solución perfecta de mobiliario industrial para espacios modernos. Este marco de diván industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima durabilidad y atractivo visual.\n\nElaborado en nuestro taller de Bekasi desde 1999, este marco de diván industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente resistencia mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecto para lounges, áreas de espera, hoteles y espacios comerciales, este marco de diván industrial proporciona capacidades de asientos y relajación versátiles. El diseño de diván ofrece opciones de asientos y descanso cómodas para invitados y clientes.`, metaDescription: 'Marco de Diván Industrial - Marco de Diván de Acero | Mobiliario de Lounge | Mangala Living', imageAlt: 'Marco de Diván Industrial - Diván de Acero - Mobiliario Premium de Mangala Living' },
    fr: { name: 'Cadre de Lit de Jour Industriel', caption: 'Cadre de Lit de Jour Industriel - Cadre de Lit de Jour en Acier pour Espaces Lounge | Mangala Living', shortCaption: 'Cadre de Lit de Jour Industriel - Lit de Jour en Acier', description: `Le Cadre de Lit de Jour Industriel de Mangala Living est la solution parfaite de mobilier industriel pour les espaces modernes. Ce cadre de lit de jour industriel premium présente un design industriel robuste avec une construction en acier qui offre une durabilité maximale et un attrait visuel.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, ce cadre de lit de jour industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente résistance tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfait pour les lounges, les zones d'attente, les hôtels et les espaces commerciaux, ce cadre de lit de jour industriel offre des capacités d'assise et de relaxation polyvalentes. Le design de lit de jour offre des options d'assise et de détente confortables pour les invités et les clients.`, metaDescription: 'Cadre de Lit de Jour Industriel - Cadre de Lit de Jour en Acier | Mobilier de Lounge | Mangala Living', imageAlt: 'Cadre de Lit de Jour Industriel - Lit de Jour en Acier - Mobilier Premium de Mangala Living' },
    ko: { name: '인더스트리얼 데이베드 프레임', caption: '인더스트리얼 데이베드 프레임 - 라운지 공간용 강철 데이베드 프레임 | Mangala Living', shortCaption: '인더스트리얼 데이베드 프레임 - 강철 데이베드', description: `Mangala Living의 인더스트리얼 데이베드 프레임은 현대 공간을 위한 완벽한 인더스트리얼 가구 솔루션입니다. 이 프리미엄 인더스트리얼 데이베드 프레임은 최대 내구성과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 데이베드 프레임은 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 강도를 제공합니다.\n\n라운지, 대기 공간, 호텔 및 상업 공간에 완벽한 이 인더스트리얼 데이베드 프레임은 다목적 좌석 및 휴식 기능을 제공합니다. 데이베드 디자인은 손님과 고객을 위한 편안한 좌석 및 라운지 옵션을 제공합니다.`, metaDescription: '인더스트리얼 데이베드 프레임 - 강철 데이베드 프레임 | 라운지 가구 | Mangala Living', imageAlt: '인더스트리얼 데이베드 프레임 - 강철 데이베드 - Mangala Living의 프리미엄 가구' }
  },
...
Sempurna untuk rumah, kafe, restoran, dan ruang makan komersial, meja makan industrial ini menyediakan kapasitas makan yang serbaguna. Desain industrial menciptakan titik fokus untuk area makan sambil menawarkan fungsionalitas praktis untuk penggunaan harian.`,
    ...
    ar: { name: 'طاولة طعام بانودنج بايب', caption: 'طاولة طعام بانودنج بايب - طاولة طعام صناعية للمنزل والمطعم | Mangala Living', shortCaption: 'طاولة طعام بانودنج بايب - طاولة طعام صناعية', description: `طاولة طعام بانودنج بايب من Mangala Living هي الحل الأمثل لتناول الطعام الصناعي للمنازل الحديثة والمقاهي والمطاعم. تتميز طاولة الطعام الصناعية المميزة هذه بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من المتانة والجاذبية البصرية.\n\nصُنعت في ورشة بيكاسي لدينا منذ عام 1999، تعرض طاولة الطعام الصناعية هذه تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي استقرارًا ممتازًا مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالية للمنازل والمقاهي والمطاعم ومساحات تناول الطعام التجارية، توفر طاولة الطعام الصناعية هذه قدرات طعام متعددة الاستخدامات. يخلق التصميم الصناعي نقطة محورية لمناطق تناول الطعام مع توفير وظائف عملية للاستخدام اليومي.`, metaDescription: 'طاولة طعام بانودنج بايب - طاولة طعام صناعية | أثاث مخصص | Mangala Living', imageAlt: 'طاولة طعام بانودنج بايب - طاولة طعام صناعية - أثاث مميز من Mangala Living' },
    zh: { name: '万隆管道餐桌', caption: '万隆管道餐桌 - 家居和餐厅用工业餐桌 | Mangala Living', shortCaption: '万隆管道餐桌 - 工业餐桌', description: `Mangala Living的万隆管道餐桌是现代家居、咖啡馆和餐厅的完美工业用餐解决方案。这款优质工业餐桌采用坚固的工业设计和钢结构，提供最大的耐用性和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业餐桌展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的稳定性，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合家居、咖啡馆、餐厅和商业用餐空间，这款工业餐桌提供多功能用餐能力。工业设计为用餐区创造了一个焦点，同时为日常使用提供实用功能。`, metaDescription: '万隆管道餐桌 - 工业餐桌 | 定制家具 | Mangala Living', imageAlt: '万隆管道餐桌 - 工业餐桌 - Mangala Living的优质家具' },
    ja: { name: 'バンドンパイプダイニングテーブル', caption: 'バンドンパイプダイニングテーブル - ホームとレストラン用工業用ダイニングテーブル | Mangala Living', shortCaption: 'バンドンパイプダイニングテーブル - 工業用ダイニングテーブル', description: `Mangala Livingのバンドンパイプダイニングテーブルは、モダンな家庭、カフェ、レストランのための完璧な工業用ダイニングソリューションです。このプレミアム工業用ダイニングテーブルは、最大限の耐久性と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用ダイニングテーブルは、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた安定性を提供します。\n\n家庭、カフェ、レストラン、商業用ダイニングスペースに最適で、この工業用ダイニングテーブルは多目的なダイニング機能を提供します。工業デザインは、ダイニングエリアの焦点を作り出しながら、日常使用のための実用的な機能を提供します。`, metaDescription: 'バンドンパイプダイニングテーブル - 工業用ダイニングテーブル | カスタム家具 | Mangala Living', imageAlt: 'バンドンパイプダイニングテーブル - 工業用ダイニングテーブル - Mangala Livingのプレミアム家具' },
    es: { name: 'Mesa de Comedor Bandung Pipe', caption: 'Mesa de Comedor Bandung Pipe - Mesa de Comedor Industrial para Hogar y Restaurante | Mangala Living', shortCaption: 'Mesa de Comedor Bandung Pipe - Mesa de Comedor Industrial', description: `La Mesa de Comedor Bandung Pipe de Mangala Living es la solución perfecta de comedor industrial para hogares modernos, cafés y restaurantes. Esta mesa de comedor industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima durabilidad y atractivo visual.\n\nElaborada en nuestro taller de Bekasi desde 1999, esta mesa de comedor industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente estabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecta para hogares, cafés, restaurantes y espacios de comedor comerciales, esta mesa de comedor industrial proporciona capacidades de comedor versátiles. El diseño industrial crea un punto focal para las áreas de comedor mientras ofrece funcionalidad práctica para el uso diario.`, metaDescription: 'Mesa de Comedor Bandung Pipe - Mesa de Comedor Industrial | Mobiliario Personalizado | Mangala Living', imageAlt: 'Mesa de Comedor Bandung Pipe - Mesa de Comedor Industrial - Mobiliario Premium de Mangala Living' },
    fr: { name: 'Table à Manger Bandung Pipe', caption: 'Table à Manger Bandung Pipe - Table à Manger Industrielle pour Maison et Restaurant | Mangala Living', shortCaption: 'Table à Manger Bandung Pipe - Table à Manger Industrielle', description: `La Table à Manger Bandung Pipe de Mangala Living est la solution parfaite de salle à manger industrielle pour les maisons modernes, les cafés et les restaurants. Cette table à manger industrielle premium présente un design industriel robuste avec une construction en acier qui offre une durabilité maximale et un attrait visuel.\n\nFabriquée dans notre atelier de Bekasi depuis 1999, cette table à manger industrielle présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente stabilité tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfaite pour les maisons, les cafés, les restaurants et les espaces de restauration commerciaux, cette table à manger industrielle offre des capacités de restauration polyvalentes. Le design industriel crée un point focal pour les zones de restauration tout en offrant une fonctionnalité pratique pour un usage quotidien.`, metaDescription: 'Table à Manger Bandung Pipe - Table à Manger Industrielle | Mobilier Personnalisé | Mangala Living', imageAlt: 'Table à Manger Bandung Pipe - Table à Manger Industrielle - Mobilier Premium de Mangala Living' },
    ko: { name: '반둥 파이프 다이닝 테이블', caption: '반둥 파이프 다이닝 테이블 - 가정 및 레스토랑용 인더스트리얼 다이닝 테이블 | Mangala Living', shortCaption: '반둥 파이프 다이닝 테이블 - 인더스트리얼 다이닝 테이블', description: `Mangala Living의 반둥 파이프 다이닝 테이블은 현대 가정, 카페 및 레스토랑을 위한 완벽한 인더스트리얼 다이닝 솔루션입니다. 이 프리미엄 인더스트리얼 다이닝 테이블은 최대 내구성과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 다이닝 테이블은 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 안정성을 제공합니다.\n\n가정, 카페, 레스토랑 및 상업 식사 공간에 완벽한 이 인더스트리얼 다이닝 테이블은 다목적 식사 기능을 제공합니다. 인더스트리얼 디자인은 식사 공간의 초점을 만들면서 일상 사용을 위한 실용적인 기능을 제공합니다.`, metaDescription: '반둥 파이프 다이닝 테이블 - 인더스트리얼 다이닝 테이블 | 맞춤 가구 | Mangala Living', imageAlt: '반둥 파이프 다이닝 테이블 - 인더스트리얼 다이닝 테이블 - Mangala Living의 프리미엄 가구' }
  },
...
Sempurna untuk rumah, kafe, restoran, dan ruang makan komersial, set meja makan industrial ini menyediakan kapasitas makan yang serbaguna. Desain industrial menciptakan titik fokus untuk area makan sambil menawarkan fungsionalitas praktis untuk penggunaan harian.`,
    ...
    ar: { name: 'طقم طعام مع 2 كرسي', caption: 'طقم طعام مع 2 كرسي - طقم طعام صناعي كامل | Mangala Living', shortCaption: 'طقم طعام مع 2 كرسي - طقم طعام كامل', description: `طقم الطعام مع 2 كرسي من Mangala Living هو الحل الأمثل لتناول الطعام الصناعي للمنازل الحديثة والمقاهي والمطاعم. يتميز طقم الطعام الصناعي المميز هذا بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من المتانة والجاذبية البصرية.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض طقم الطعام الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي استقرارًا ممتازًا مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالي للمنازل والمقاهي والمطاعم ومساحات تناول الطعام التجارية، يوفر طقم الطعام الصناعي هذا قدرات طعام متعددة الاستخدامات. يخلق التصميم الصناعي نقطة محورية لمناطق تناول الطعام مع توفير وظائف عملية للاستخدام اليومي.`, metaDescription: 'طقم طعام مع 2 كرسي - طقم طعام صناعي كامل | أثاث مخصص | Mangala Living', imageAlt: 'طقم طعام مع 2 كرسي - طقم طعام صناعي كامل - أثاث مميز من Mangala Living' },
    zh: { name: '带2把椅子的餐桌套装', caption: '带2把椅子的餐桌套装 - 完整的工业餐桌套装 | Mangala Living', shortCaption: '带2把椅子的餐桌套装 - 完整的餐桌套装', description: `Mangala Living的带2把椅子的餐桌套装是现代家居、咖啡馆和餐厅的完美工业用餐解决方案。这款优质工业餐桌套装采用坚固的工业设计和钢结构，提供最大的耐用性和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业餐桌套装展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的稳定性，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合家居、咖啡馆、餐厅和商业用餐空间，这款工业餐桌套装提供多功能用餐能力。工业设计为用餐区创造了一个焦点，同时为日常使用提供实用功能。`, metaDescription: '带2把椅子的餐桌套装 - 完整的工业餐桌套装 | 定制家具 | Mangala Living', imageAlt: '带2把椅子的餐桌套装 - 完整的工业餐桌套装 - Mangala Living的优质家具' },
    ja: { name: '2脚の椅子付きダイニングセット', caption: '2脚の椅子付きダイニングセット - 完全な工業用ダイニングセット | Mangala Living', shortCaption: '2脚の椅子付きダイニングセット - 完全なダイニングセット', description: `Mangala Livingの2脚の椅子付きダイニングセットは、モダンな家庭、カフェ、レストランのための完璧な工業用ダイニングソリューションです。このプレミアム工業用ダイニングセットは、最大限の耐久性と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用ダイニングセットは、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた安定性を提供します。\n\n家庭、カフェ、レストラン、商業用ダイニングスペースに最適で、この工業用ダイニングセットは多目的なダイニング機能を提供します。工業デザインは、ダイニングエリアの焦点を作り出しながら、日常使用のための実用的な機能を提供します。`, metaDescription: '2脚の椅子付きダイニングセット - 完全な工業用ダイニングセット | カスタム家具 | Mangala Living', imageAlt: '2脚の椅子付きダイニングセット - 完全な工業用ダイニングセット - Mangala Livingのプレミアム家具' },
    es: { name: 'Juego de Comedor con 2 Sillas', caption: 'Juego de Comedor con 2 Sillas - Juego de Comedor Industrial Completo | Mangala Living', shortCaption: 'Juego de Comedor con 2 Sillas - Juego de Comedor Completo', description: `El Juego de Comedor con 2 Sillas de Mangala Living es la solución perfecta de comedor industrial para hogares modernos, cafés y restaurantes. Este juego de comedor industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima durabilidad y atractivo visual.\n\nElaborado en nuestro taller de Bekasi desde 1999, este juego de comedor industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente estabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecto para hogares, cafés, restaurantes y espacios de comedor comerciales, este juego de comedor industrial proporciona capacidades de comedor versátiles. El diseño industrial crea un punto focal para las áreas de comedor mientras ofrece funcionalidad práctica para el uso diario.`, metaDescription: 'Juego de Comedor con 2 Sillas - Juego de Comedor Industrial Completo | Mobiliario Personalizado | Mangala Living', imageAlt: 'Juego de Comedor con 2 Sillas - Juego de Comedor Industrial Completo - Mobiliario Premium de Mangala Living' },
    fr: { name: 'Ensemble de Salle à Manger avec 2 Chaises', caption: 'Ensemble de Salle à Manger avec 2 Chaises - Ensemble de Salle à Manger Industriel Complet | Mangala Living', shortCaption: 'Ensemble de Salle à Manger avec 2 Chaises - Ensemble de Salle à Manger Complet', description: `L'Ensemble de Salle à Manger avec 2 Chaises de Mangala Living est la solution parfaite de salle à manger industrielle pour les maisons modernes, les cafés et les restaurants. Cet ensemble de salle à manger industriel premium présente un design industriel robuste avec une construction en acier qui offre une durabilité maximale et un attrait visuel.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, cet ensemble de salle à manger industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente stabilité tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfait pour les maisons, les cafés, les restaurants et les espaces de restauration commerciaux, cet ensemble de salle à manger industriel offre des capacités de restauration polyvalentes. Le design industriel crée un point focal pour les zones de restauration tout en offrant une fonctionnalité pratique pour un usage quotidien.`, metaDescription: 'Ensemble de Salle à Manger avec 2 Chaises - Ensemble de Salle à Manger Industriel Complet | Mobilier Personnalisé | Mangala Living', imageAlt: 'Ensemble de Salle à Manger avec 2 Chaises - Ensemble de Salle à Manger Industriel Complet - Mobilier Premium de Mangala Living' },
    ko: { name: '2개의 의자가 있는 다이닝 세트', caption: '2개의 의자가 있는 다이닝 세트 - 완전한 인더스트리얼 다이닝 세트 | Mangala Living', shortCaption: '2개의 의자가 있는 다이닝 세트 - 완전한 다이닝 세트', description: `Mangala Living의 2개의 의자가 있는 다이닝 세트는 현대 가정, 카페 및 레스토랑을 위한 완벽한 인더스트리얼 다이닝 솔루션입니다. 이 프리미엄 인더스트리얼 다이닝 세트는 최대 내구성과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 다이닝 세트는 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 안정성을 제공합니다.\n\n가정, 카페, 레스토랑 및 상업 식사 공간에 완벽한 이 인더스트리얼 다이닝 세트는 다목적 식사 기능을 제공합니다. 인더스트리얼 디자인은 식사 공간의 초점을 만들면서 일상 사용을 위한 실용적인 기능을 제공합니다.`, metaDescription: '2개의 의자가 있는 다이닝 세트 - 완전한 인더스트리얼 다이닝 세트 | 맞춤 가구 | Mangala Living', imageAlt: '2개의 의자가 있는 다이닝 세트 - 완전한 인더스트리얼 다이닝 세트 - Mangala Living의 프리미엄 가구' }
  },
...
Sempurna untuk kafe outdoor, restoran, patio, dan ruang outdoor komersial, set bar outdoor industrial ini menyediakan kapasitas makan dan hiburan outdoor yang serbaguna. Powder coating tahan cuaca memastikan perlindungan tahan lama terhadap kondisi outdoor yang keras.`,
    ...
    ar: { name: 'طقم بار خارجي ستيل فريم', caption: 'طقم بار خارجي ستيل فريم - طقم أثاث بار خارجي صناعي | Mangala Living', shortCaption: 'طقم بار خارجي ستيل فريم - طقم بار خارجي', description: `طقم البار الخارجي Steelframe من Mangala Living هو الحل الأمثل للأثاث الخارجي الصناعي للمساحات الحديثة. يتميز طقم البار الخارجي الصناعي المميز هذا بتصميم صناعي قوي مع هيكل مقاوم للطقس يوفر أقصى قدر من المتانة للاستخدام الخارجي.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض طقم البار الخارجي الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي استقرارًا ممتازًا مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم خارجي أو صناعي.\n\nمثالي للمقاهي الخارجية والمطاعم والفناءات والمساحات الخارجية التجارية، يوفر طقم البار الخارجي الصناعي هذا قدرات طعام وترفيه خارجية متعددة الاستخدامات. يضمن الطلاء المسحوق المقاوم للطقس حماية طويلة الأمد ضد ظروف الطقس القاسية.`, metaDescription: 'طقم بار خارجي ستيل فريم - أثاث بار خارجي صناعي | مقاوم للطقس | Mangala Living', imageAlt: 'طقم بار خارجي ستيل فريم - أثاث بار خارجي صناعي - مقاوم للطقس من Mangala Living' },
    zh: { name: 'Steelframe户外吧台套装', caption: 'Steelframe户外吧台套装 - 户外工业吧台家具套装 | Mangala Living', shortCaption: 'Steelframe户外吧台套装 - 户外吧台套装', description: `Mangala Living的Steelframe户外吧台套装是现代空间的完美工业户外家具解决方案。这款优质工业户外吧台套装采用坚固的工业设计和耐候结构，为户外使用提供最大的耐用性。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业户外吧台套装展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的稳定性，同时保持时尚现代的美学，可以补充任何户外或工业设计。\n\n非常适合户外咖啡馆、餐厅、露台和商业户外空间，这款工业户外吧台套装提供多功能户外用餐和娱乐能力。耐候粉末涂层确保对恶劣户外条件的持久保护。`, metaDescription: 'Steelframe户外吧台套装 - 户外工业吧台家具 | 耐候 | Mangala Living', imageAlt: 'Steelframe户外吧台套装 - 户外工业吧台家具 - Mangala Living的耐候产品' },
    ja: { name: 'Steelframe アウトドアバーセット', caption: 'Steelframe アウトドアバーセット - 屋外工業用バー家具セット | Mangala Living', shortCaption: 'Steelframe アウトドアバーセット - アウトドアバーセット', description: `Mangala LivingのSteelframe アウトドアバーセットは、モダンな空間のための完璧な工業用屋外家具ソリューションです。このプレミアム工業用屋外バーセットは、屋外使用のための最大限の耐久性を提供する耐候性構造を備えた頑丈な工業デザインが特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用屋外バーセットは、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる屋外または工業デザインを補完する洗練された現代的な美学を維持しながら、優れた安定性を提供します。\n\n屋外カフェ、レストラン、パティオ、商業用屋外スペースに最適で、この工業用屋外バーセットは多目的な屋外ダイニングとエンターテイメント機能を提供します。耐候性パウダーコーティングにより、厳しい屋外条件に対する長期的な保護が保証されます。`, metaDescription: 'Steelframe アウトドアバーセット - 屋外工業用バー家具 | 耐候性 | Mangala Living', imageAlt: 'Steelframe アウトドアバーセット - 屋外工業用バー家具 - Mangala Livingの耐候性製品' },
    es: { name: 'Juego de Bar Exterior Steelframe', caption: 'Juego de Bar Exterior Steelframe - Juego de Mobiliario de Bar Exterior Industrial | Mangala Living', shortCaption: 'Juego de Bar Exterior Steelframe - Juego de Bar Exterior', description: `El Juego de Bar Exterior Steelframe de Mangala Living es la solución perfecta de mobiliario exterior industrial para espacios modernos. Este juego de bar exterior industrial premium presenta un diseño industrial robusto con construcción resistente a la intemperie que proporciona la máxima durabilidad para uso exterior.\n\nElaborado en nuestro taller de Bekasi desde 1999, este juego de bar exterior industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente estabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño exterior o industrial.\n\nPerfecto para cafés al aire libre, restaurantes, patios y espacios comerciales al aire libre, este juego de bar exterior industrial proporciona capacidades de comedor y entretenimiento al aire libre versátiles. El revestimiento en polvo resistente a la intemperie garantiza una protección duradera contra condiciones exteriores adversas.`, metaDescription: 'Juego de Bar Exterior Steelframe - Mobiliario de Bar Exterior Industrial | Resistente a la Intemperie | Mangala Living', imageAlt: 'Juego de Bar Exterior Steelframe - Mobiliario de Bar Exterior Industrial - Resistente a la Intemperie de Mangala Living' },
    fr: { name: 'Ensemble de Bar Extérieur Steelframe', caption: 'Ensemble de Bar Extérieur Steelframe - Ensemble de Mobilier de Bar Extérieur Industriel | Mangala Living', shortCaption: 'Ensemble de Bar Extérieur Steelframe - Ensemble de Bar Extérieur', description: `L'Ensemble de Bar Extérieur Steelframe de Mangala Living est la solution parfaite de mobilier extérieur industriel pour les espaces modernes. Cet ensemble de bar extérieur industriel premium présente un design industriel robuste avec une construction résistante aux intempéries qui offre une durabilité maximale pour une utilisation en extérieur.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, cet ensemble de bar extérieur industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente stabilité tout en maintenant une esthétique moderne élégante qui complète tout design extérieur ou industriel.\n\nParfait pour les cafés en plein air, les restaurants, les patios et les espaces commerciaux extérieurs, cet ensemble de bar extérieur industriel offre des capacités de restauration et de divertissement en plein air polyvalentes. Le revêtement en poudre résistant aux intempéries garantit une protection durable contre les conditions extérieures difficiles.`, metaDescription: 'Ensemble de Bar Extérieur Steelframe - Mobilier de Bar Extérieur Industriel | Résistant aux Intempéries | Mangala Living', imageAlt: 'Ensemble de Bar Extérieur Steelframe - Mobilier de Bar Extérieur Industriel - Résistant aux Intempéries de Mangala Living' },
    ko: { name: 'Steelframe 야외 바 세트', caption: 'Steelframe 야외 바 세트 - 야외 인더스트리얼 바 가구 세트 | Mangala Living', shortCaption: 'Steelframe 야외 바 세트 - 야외 바 세트', description: `Mangala Living의 Steelframe 야외 바 세트는 현대 공간을 위한 완벽한 인더스트리얼 야외 가구 솔루션입니다. 이 프리미엄 인더스트리얼 야외 바 세트는 야외 사용을 위한 최대 내구성을 제공하는 내후성 구조를 갖춘 견고한 인더스트리얼 디자인이 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 야외 바 세트는 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 야외 또는 인더스트리얼 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 안정성을 제공합니다.\n\n야외 카페, 레스토랑, 파티오 및 상업 야외 공간에 완벽한 이 인더스트리얼 야외 바 세트는 다목적 야외 식사 및 엔터테인먼트 기능을 제공합니다. 내후성 분말 코팅은 가혹한 야외 조건에 대한 오래 지속되는 보호를 보장합니다.`, metaDescription: 'Steelframe 야외 바 세트 - 야외 인더스트리얼 바 가구 | 내후성 | Mangala Living', imageAlt: 'Steelframe 야외 바 세트 - 야외 인더스트리얼 바 가구 - Mangala Living의 내후성 제품' }
  },
...
Sempurna untuk kantor, kafe, restoran, dan ruang komersial, furniture penyimpanan industrial ini menyediakan kapasitas penyimpanan yang serbaguna. Desain industrial menciptakan solusi penyimpanan fungsional sambil menambah minat visual untuk ruang apa pun.`,
    ...
    ar: { name: 'خزانة مطبخ صناعية', caption: 'خزانة مطبخ صناعية - خزانة تخزين مطبخ فولاذية | Mangala Living', shortCaption: 'خزانة مطبخ صناعية - خزانة مطبخ فولاذية', description: `خزانة المطبخ الصناعية من Mangala Living هي الحل الأمثل للتخزين الصناعي للمساحات الحديثة. يتميز أثاث التخزين الصناعي المميز هذا بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من سعة التخزين والجاذبية البصرية.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض أثاث التخزين الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي متانة ممتازة مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالية للمكاتب والمقاهي والمطاعم والمساحات التجارية، يوفر أثاث التخزين الصناعي هذا قدرات تخزين متعددة الاستخدامات. يخلق التصميم الصناعي حلول تخزين وظيفية مع إضافة اهتمام بصري لأي مساحة.`, metaDescription: 'خزانة مطبخ صناعية - خزانة تخزين مطبخ فولاذية | أثاث مخصص | Mangala Living', imageAlt: 'خزانة مطبخ صناعية - خزانة مطبخ فولاذية - تخزين مميز من Mangala Living' },
    zh: { name: '工业厨房橱柜', caption: '工业厨房橱柜 - 钢制厨房储物柜 | Mangala Living', shortCaption: '工业厨房橱柜 - 钢制厨房橱柜', description: `Mangala Living的工业厨房橱柜是现代空间的完美工业储物解决方案。这款优质工业储物家具采用坚固的工业设计和钢结构，提供最大的存储容量和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业储物家具展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的耐用性，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合办公室、咖啡馆、餐厅和商业空间，这款工业储物家具提供多功能存储能力。工业设计创造了功能性存储解决方案，同时为任何空间增添视觉趣味。`, metaDescription: '工业厨房橱柜 - 钢制厨房储物柜 | 定制家具 | Mangala Living', imageAlt: '工业厨房橱柜 - 钢制厨房橱柜 - Mangala Living的优质存储' },
    ja: { name: 'インダストリアル キッチンキャビネット', caption: 'インダストリアル キッチンキャビネット - スチールキッチン収納キャビネット | Mangala Living', shortCaption: 'インダストリアル キッチンキャビネット - スチールキッチンキャビネット', description: `Mangala Livingのインダストリアル キッチンキャビネットは、モダンな空間のための完璧な工業用収納ソリューションです。このプレミアム工業用収納家具は、最大限の収納容量と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用収納家具は、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた耐久性を提供します。\n\nオフィス、カフェ、レストラン、商業空間に最適で、この工業用収納家具は多目的な収納機能を提供します。工業デザインは、あらゆる空間に視覚的な興味を加えながら、機能的な収納ソリューションを作り出します。`, metaDescription: 'インダストリアル キッチンキャビネット - スチールキッチン収納キャビネット | カスタム家具 | Mangala Living', imageAlt: 'インダストリアル キッチンキャビネット - スチールキッチンキャビネット - Mangala Livingのプレミアム収納' },
    es: { name: 'Gabinete de Cocina Industrial', caption: 'Gabinete de Cocina Industrial - Gabinete de Almacenamiento de Cocina de Acero | Mangala Living', shortCaption: 'Gabinete de Cocina Industrial - Gabinete de Cocina de Acero', description: `El Gabinete de Cocina Industrial de Mangala Living es la solución perfecta de almacenamiento industrial para espacios modernos. Este mueble de almacenamiento industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima capacidad de almacenamiento y atractivo visual.\n\nElaborado en nuestro taller de Bekasi desde 1999, este mueble de almacenamiento industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente durabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecto para oficinas, cafeterías, restaurantes y espacios comerciales, este mueble de almacenamiento industrial proporciona capacidades de almacenamiento versátiles. El diseño industrial crea soluciones de almacenamiento funcionales mientras agrega interés visual a cualquier espacio.`, metaDescription: 'Gabinete de Cocina Industrial - Gabinete de Almacenamiento de Cocina de Acero | Mobiliario Personalizado | Mangala Living', imageAlt: 'Gabinete de Cocina Industrial - Gabinete de Cocina de Acero - Almacenamiento Premium de Mangala Living' },
    fr: { name: 'Armoire de Cuisine Industrielle', caption: 'Armoire de Cuisine Industrielle - Armoire de Rangement de Cuisine en Acier | Mangala Living', shortCaption: 'Armoire de Cuisine Industrielle - Armoire de Cuisine en Acier', description: `L'Armoire de Cuisine Industrielle de Mangala Living est la solution parfaite de rangement industriel pour les espaces modernes. Ce meuble de rangement industriel premium présente un design industriel robuste avec une construction en acier qui offre une capacité de rangement maximale et un attrait visuel.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, ce meuble de rangement industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente durabilité tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfait pour les bureaux, les cafés, les restaurants et les espaces commerciaux, ce meuble de rangement industriel offre des capacités de rangement polyvalentes. Le design industriel crée des solutions de rangement fonctionnelles tout en ajoutant un intérêt visuel à n'importe quel espace.`, metaDescription: 'Armoire de Cuisine Industrielle - Armoire de Rangement de Cuisine en Acier | Mobilier Personnalisé | Mangala Living', imageAlt: 'Armoire de Cuisine Industrielle - Armoire de Cuisine en Acier - Rangement Premium de Mangala Living' },
    ko: { name: '인더스트리얼 주방 캐비닛', caption: '인더스트리얼 주방 캐비닛 - 강철 주방 수납 캐비닛 | Mangala Living', shortCaption: '인더스트리얼 주방 캐비닛 - 강철 주방 캐비닛', description: `Mangala Living의 인더스트리얼 주방 캐비닛은 현대 공간을 위한 완벽한 인더스트리얼 수납 솔루션입니다. 이 프리미엄 인더스트리얼 수납 가구는 최대 수납 용량과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 수납 가구는 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 내구성을 제공합니다.\n\n사무실, 카페, 레스토랑 및 상업 공간에 완벽한 이 인더스트리얼 수납 가구는 다목적 수납 기능을 제공합니다. 인더스트리얼 디자인은 모든 공간에 시각적 흥미를 더하면서 기능적인 수납 솔루션을 만들어냅니다.`, metaDescription: '인더스트리얼 주방 캐비닛 - 강철 주방 수납 캐비닛 | 맞춤 가구 | Mangala Living', imageAlt: '인더스트리얼 주방 캐비닛 - 강철 주방 캐비닛 - Mangala Living의 프리미엄 수납' }
  },
...
Sempurna untuk kantor, kafe, restoran, dan ruang komersial, furniture penyimpanan industrial ini menyediakan kapasitas penyimpanan yang serbaguna. Desain industrial menciptakan solusi penyimpanan fungsional sambil menambah minat visual untuk ruang apa pun.`,
    ...
    ar: { name: 'خزانة تخزين صناعية', caption: 'خزانة تخزين صناعية - خزانة ملابس صناعية | Mangala Living', shortCaption: 'خزانة تخزين صناعية - خزانة ملابس', description: `خزانة Kabinet Lemari Industrial من Mangala Living هي الحل الأمثل للتخزين الصناعي للمساحات الحديثة. يتميز أثاث التخزين الصناعي المميز هذا بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من سعة التخزين والجاذبية البصرية.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض أثاث التخزين الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي متانة ممتازة مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالي للمكاتب والمقاهي والمطاعم والمساحات التجارية، يوفر أثاث التخزين الصناعي هذا قدرات تخزين متعددة الاستخدامات. يخلق التصميم الصناعي حلول تخزين وظيفية مع إضافة اهتمام بصري لأي مساحة.`, metaDescription: 'خزانة تخزين صناعية - خزانة ملابس صناعية | أثاث مخصص | Mangala Living', imageAlt: 'خزانة تخزين صناعية - خزانة ملابس صناعية - تخزين مميز من Mangala Living' },
    zh: { name: '工业储物柜', caption: '工业储物柜 - 工业衣柜 | Mangala Living', shortCaption: '工业储物柜 - 衣柜', description: `Mangala Living的Kabinet Lemari Industrial是现代空间的完美工业储物解决方案。这款优质工业储物家具采用坚固的工业设计和钢结构，提供最大的存储容量和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业储物家具展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的耐用性，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合办公室、咖啡馆、餐厅和商业空间，这款工业储物家具提供多功能存储能力。工业设计创造了功能性存储解决方案，同时为任何空间增添视觉趣味。`, metaDescription: '工业储物柜 - 工业衣柜 | 定制家具 | Mangala Living', imageAlt: '工业储物柜 - 工业衣柜 - Mangala Living的优质存储' },
    ja: { name: 'インダストリアル 収納キャビネット', caption: 'インダストリアル 収納キャビネット - インダストリアル ワードローブキャビネット | Mangala Living', shortCaption: 'インダストリアル 収納キャビネット - ワードローブキャビネット', description: `Mangala LivingのKabinet Lemari Industrialは、モダンな空間のための完璧な工業用収納ソリューションです。このプレミアム工業用収納家具は、最大限の収納容量と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用収納家具は、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた耐久性を提供します。\n\nオフィス、カフェ、レストラン、商業空間に最適で、この工業用収納家具は多目的な収納機能を提供します。工業デザインは、あらゆる空間に視覚的な興味を加えながら、機能的な収納ソリューションを作り出します。`, metaDescription: 'インダストリアル 収納キャビネット - インダストリアル ワードローブキャビネット | カスタム家具 | Mangala Living', imageAlt: 'インダストリアル 収納キャビネット - インダストリアル ワードローブキャビネット - Mangala Livingのプレミアム収納' },
    es: { name: 'Gabinete de Almacenamiento Industrial', caption: 'Gabinete de Almacenamiento Industrial - Gabinete de Armario Industrial | Mangala Living', shortCaption: 'Gabinete de Almacenamiento Industrial - Gabinete de Armario', description: `El Kabinet Lemari Industrial de Mangala Living es la solución perfecta de almacenamiento industrial para espacios modernos. Este mueble de almacenamiento industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima capacidad de almacenamiento y atractivo visual.\n\nElaborado en nuestro taller de Bekasi desde 1999, este mueble de almacenamiento industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente durabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecto para oficinas, cafeterías, restaurantes y espacios comerciales, este mueble de almacenamiento industrial proporciona capacidades de almacenamiento versátiles. El diseño industrial crea soluciones de almacenamiento funcionales mientras agrega interés visual a cualquier espacio.`, metaDescription: 'Gabinete de Almacenamiento Industrial - Gabinete de Armario Industrial | Mobiliario Personalizado | Mangala Living', imageAlt: 'Gabinete de Almacenamiento Industrial - Gabinete de Armario Industrial - Almacenamiento Premium de Mangala Living' },
    fr: { name: 'Armoire de Rangement Industrielle', caption: 'Armoire de Rangement Industrielle - Armoire-Penderie Industrielle | Mangala Living', shortCaption: 'Armoire de Rangement Industrielle - Armoire-Penderie', description: `Le Kabinet Lemari Industrial de Mangala Living est la solution parfaite de rangement industriel pour les espaces modernes. Ce meuble de rangement industriel premium présente un design industriel robuste avec une construction en acier qui offre une capacité de rangement maximale et un attrait visuel.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, ce meuble de rangement industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente durabilité tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfait pour les bureaux, les cafés, les restaurants et les espaces commerciaux, ce meuble de rangement industriel offre des capacités de rangement polyvalentes. Le design industriel crée des solutions de rangement fonctionnelles tout en ajoutant un intérêt visuel à n'importe quel espace.`, metaDescription: 'Armoire de Rangement Industrielle - Armoire-Penderie Industrielle | Mobilier Personnalisé | Mangala Living', imageAlt: 'Armoire de Rangement Industrielle - Armoire-Penderie Industrielle - Rangement Premium de Mangala Living' },
    ko: { name: '인더스트리얼 수납 캐비닛', caption: '인더스트리얼 수납 캐비닛 - 인더스트리얼 옷장 캐비닛 | Mangala Living', shortCaption: '인더스트리얼 수납 캐비닛 - 옷장 캐비닛', description: `Mangala Living의 Kabinet Lemari Industrial은 현대 공간을 위한 완벽한 인더스트리얼 수납 솔루션입니다. 이 프리미엄 인더스트리얼 수납 가구는 최대 수납 용량과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 수납 가구는 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 내구성을 제공합니다.\n\n사무실, 카페, 레스토랑 및 상업 공간에 완벽한 이 인더스트리얼 수납 가구는 다목적 수납 기능을 제공합니다. 인더스트리얼 디자인은 모든 공간에 시각적 흥미를 더하면서 기능적인 수납 솔루션을 만들어냅니다.`, metaDescription: '인더스트리얼 수납 캐비닛 - 인더스트리얼 옷장 캐비닛 | 맞춤 가구 | Mangala Living', imageAlt: '인더스트리얼 수납 캐비닛 - 인더스트리얼 옷장 캐비닛 - Mangala Living의 프리미엄 수납' }
  },
...
Sempurna untuk kantor, kafe, restoran, dan ruang komersial, furniture penyimpanan industrial ini menyediakan kapasitas penyimpanan yang serbaguna. Desain industrial menciptakan solusi penyimpanan fungsional sambil menambah minat visual untuk ruang apa pun.`,
    ...
    ar: { name: 'حامل عرض إطار السلم', caption: 'حامل عرض إطار السلم - حامل عرض سلم صناعي | Mangala Living', shortCaption: 'حامل عرض إطار السلم - عرض السلم', description: `حامل العرض Ladder Frame من Mangala Living هو الحل الأمثل للتخزين الصناعي للمساحات الحديثة. يتميز أثاث التخزين الصناعي المميز هذا بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من سعة التخزين والجاذبية البصرية.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض أثاث التخزين الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي متانة ممتازة مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالي للمكاتب والمقاهي والمطاعم والمساحات التجارية، يوفر أثاث التخزين الصناعي هذا قدرات تخزين متعددة الاستخدامات. يخلق التصميم الصناعي حلول تخزين وظيفية مع إضافة اهتمام بصري لأي مساحة.`, metaDescription: 'حامل عرض إطار السلم - عرض سلم صناعي | أثاث مخصص | Mangala Living', imageAlt: 'حامل عرض إطار السلم - عرض سلم صناعي - تخزين مميز من Mangala Living' },
    zh: { name: '梯架展示架', caption: '梯架展示架 - 工业梯形展示架 | Mangala Living', shortCaption: '梯架展示架 - 梯形展示', description: `Mangala Living的梯架展示架是现代空间的完美工业储物解决方案。这款优质工业储物家具采用坚固的工业设计和钢结构，提供最大的存储容量和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业储物家具展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的耐用性，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合办公室、咖啡馆、餐厅和商业空间，这款工业储物家具提供多功能存储能力。工业设计创造了功能性存储解决方案，同时为任何空间增添视觉趣味。`, metaDescription: '梯架展示架 - 工业梯形展示 | 定制家具 | Mangala Living', imageAlt: '梯架展示架 - 工业梯形展示 - Mangala Living的优质存储' },
    ja: { name: 'ラダーフレーム ディスプレイスタンド', caption: 'ラダーフレーム ディスプレイスタンド - 工業用ラダーディスプレイスタンド | Mangala Living', shortCaption: 'ラダーフレーム ディスプレイスタンド - ラダーディスプレイ', description: `Mangala Livingのラダーフレーム ディスプレイスタンドは、モダンな空間のための完璧な工業用収納ソリューションです。このプレミアム工業用収納家具は、最大限の収納容量と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用収納家具は、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた耐久性を提供します。\n\nオフィス、カフェ、レストラン、商業空間に最適で、この工業用収納家具は多目的な収納機能を提供します。工業デザインは、あらゆる空間に視覚的な興味を加えながら、機能的な収納ソリューションを作り出します。`, metaDescription: 'ラダーフレーム ディスプレイスタンド - 工業用ラダーディスプレイ | カスタム家具 | Mangala Living', imageAlt: 'ラダーフレーム ディスプレイスタンド - 工業用ラダーディスプレイ - Mangala Livingのプレミアム収納' },
    es: { name: 'Soporte de Exhibición de Marco de Escalera', caption: 'Soporte de Exhibición de Marco de Escalera - Soporte de Exhibición de Escalera Industrial | Mangala Living', shortCaption: 'Soporte de Exhibición de Marco de Escalera - Exhibición de Escalera', description: `El Soporte de Exhibición de Marco de Escalera de Mangala Living es la solución perfecta de almacenamiento industrial para espacios modernos. Este mueble de almacenamiento industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima capacidad de almacenamiento y atractivo visual.\n\nElaborado en nuestro taller de Bekasi desde 1999, este mueble de almacenamiento industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente durabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecto para oficinas, cafeterías, restaurantes y espacios comerciales, este mueble de almacenamiento industrial proporciona capacidades de almacenamiento versátiles. El diseño industrial crea soluciones de almacenamiento funcionales mientras agrega interés visual a cualquier espacio.`, metaDescription: 'Soporte de Exhibición de Marco de Escalera - Exhibición de Escalera Industrial | Mobiliario Personalizado | Mangala Living', imageAlt: 'Soporte de Exhibición de Marco de Escalera - Exhibición de Escalera Industrial - Almacenamiento Premium de Mangala Living' },
    fr: { name: 'Support d\'Exposition en Échelle', caption: 'Support d\'Exposition en Échelle - Support d\'Exposition en Échelle Industrielle | Mangala Living', shortCaption: 'Support d\'Exposition en Échelle - Exposition en Échelle', description: `Le Support d'Exposition en Échelle de Mangala Living est la solution parfaite de rangement industriel pour les espaces modernes. Ce meuble de rangement industriel premium présente un design industriel robuste avec une construction en acier qui offre une capacité de rangement maximale et un attrait visuel.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, ce meuble de rangement industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente durabilité tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfait pour les bureaux, les cafés, les restaurants et les espaces commerciaux, ce meuble de rangement industriel offre des capacités de rangement polyvalentes. Le design industriel crée des solutions de rangement fonctionnelles tout en ajoutant un intérêt visuel à n'importe quel espace.`, metaDescription: 'Support d\'Exposition en Échelle - Exposition en Échelle Industrielle | Mobilier Personnalisé | Mangala Living', imageAlt: 'Support d\'Exposition en Échelle - Exposition en Échelle Industrielle - Rangement Premium de Mangala Living' },
    ko: { name: '사다리 프레임 디스플레이 스탠드', caption: '사다리 프레임 디스플레이 스탠드 - 인더스트리얼 사다리 디스플레이 스탠드 | Mangala Living', shortCaption: '사다리 프레임 디스플레이 스탠드 - 사다리 디스플레이', description: `Mangala Living의 사다리 프레임 디스플레이 스탠드는 현대 공간을 위한 완벽한 인더스트리얼 수납 솔루션입니다. 이 프리미엄 인더스트리얼 수납 가구는 최대 수납 용량과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 수납 가구는 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 내구성을 제공합니다.\n\n사무실, 카페, 레스토랑 및 상업 공간에 완벽한 이 인더스트리얼 수납 가구는 다목적 수납 기능을 제공합니다. 인더스트리얼 디자인은 모든 공간에 시각적 흥미를 더하면서 기능적인 수납 솔루션을 만들어냅니다.`, metaDescription: '사다리 프레임 디스플레이 스탠드 - 인더스트리얼 사다리 디스플레이 | 맞춤 가구 | Mangala Living', imageAlt: '사다리 프레임 디스플레이 스탠드 - 인더스트리얼 사다리 디스플레이 - Mangala Living의 프리미엄 수납' }
  },
...
Sempurna untuk kantor, kafe, restoran, dan ruang komersial, furniture penyimpanan industrial ini menyediakan kapasitas penyimpanan yang serbaguna. Desain industrial menciptakan solusi penyimpanan fungsional sambil menambah minat visual untuk ruang apa pun.`,
    ...
    ar: { name: 'شماعة معاطف صناعية', caption: 'شماعة معاطف صناعية - شماعة معاطف فولاذية | Mangala Living', shortCaption: 'شماعة معاطف صناعية - شماعة معاطف', description: `شماعة المعاطف الصناعية من Mangala Living هي الحل الأمثل للتخزين الصناعي للمساحات الحديثة. يتميز أثاث التخزين الصناعي المميز هذا بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من سعة التخزين والجاذبية البصرية.\n\nصُنع في ورشة بيكاسي لدينا منذ عام 1999، يعرض أثاث التخزين الصناعي هذا تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي متانة ممتازة مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم داخلي صناعي أو معاصر.\n\nمثالية للمكاتب والمقاهي والمطاعم والمساحات التجارية، يوفر أثاث التخزين الصناعي هذا قدرات تخزين متعددة الاستخدامات. يخلق التصميم الصناعي حلول تخزين وظيفية مع إضافة اهتمام بصري لأي مساحة.`, metaDescription: 'شماعة معاطف صناعية - شماعة معاطف فولاذية | أثاث مخصص | Mangala Living', imageAlt: 'شماعة معاطف صناعية - شماعة معاطف فولاذية - تخزين مميز من Mangala Living' },
    zh: { name: '工业衣架', caption: '工业衣架 - 钢制衣架挂钩 | Mangala Living', shortCaption: '工业衣架 - 衣架', description: `Mangala Living的工业衣架是现代空间的完美工业储物解决方案。这款优质工业储物家具采用坚固的工业设计和钢结构，提供最大的存储容量和视觉吸引力。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业储物家具展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的耐用性，同时保持时尚现代的美学，可以补充任何工业或现代室内设计。\n\n非常适合办公室、咖啡馆、餐厅和商业空间，这款工业储物家具提供多功能存储能力。工业设计创造了功能性存储解决方案，同时为任何空间增添视觉趣味。`, metaDescription: '工业衣架 - 钢制衣架 | 定制家具 | Mangala Living', imageAlt: '工业衣架 - 钢制衣架 - Mangala Living的优质存储' },
    ja: { name: 'インダストリアル コートラック', caption: 'インダストリアル コートラック - スチールコートラックハンガー | Mangala Living', shortCaption: 'インダストリアル コートラック - コートラック', description: `Mangala Livingのインダストリアル コートラックは、モダンな空間のための完璧な工業用収納ソリューションです。このプレミアム工業用収納家具は、最大限の収納容量と視覚的な魅力を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用収納家具は、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なインテリアデザインを補完する洗練された現代的な美学を維持しながら、優れた耐久性を提供します。\n\nオフィス、カフェ、レストラン、商業空間に最適で、この工業用収納家具は多目的な収納機能を提供します。工業デザインは、あらゆる空間に視覚的な興味を加えながら、機能的な収納ソリューションを作り出します。`, metaDescription: 'インダストリアル コートラック - スチールコートラック | カスタム家具 | Mangala Living', imageAlt: 'インダストリアル コートラック - スチールコートラック - Mangala Livingのプレミアム収納' },
    es: { name: 'Perchero Industrial', caption: 'Perchero Industrial - Colgador de Abrigos de Acero | Mangala Living', shortCaption: 'Perchero Industrial - Perchero', description: `El Perchero Industrial de Mangala Living es la solución perfecta de almacenamiento industrial para espacios modernos. Este mueble de almacenamiento industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima capacidad de almacenamiento y atractivo visual.\n\nElaborado en nuestro taller de Bekasi desde 1999, este mueble de almacenamiento industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente durabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de interiores industrial o contemporáneo.\n\nPerfecto para oficinas, cafeterías, restaurantes y espacios comerciales, este mueble de almacenamiento industrial proporciona capacidades de almacenamiento versátiles. El diseño industrial crea soluciones de almacenamiento funcionales mientras agrega interés visual a cualquier espacio.`, metaDescription: 'Perchero Industrial - Perchero de Acero | Mobiliario Personalizado | Mangala Living', imageAlt: 'Perchero Industrial - Perchero de Acero - Almacenamiento Premium de Mangala Living' },
    fr: { name: 'Porte-Manteau Industriel', caption: 'Porte-Manteau Industriel - Cintre en Acier | Mangala Living', shortCaption: 'Porte-Manteau Industriel - Porte-Manteau', description: `Le Porte-Manteau Industriel de Mangala Living est la solution parfaite de rangement industriel pour les espaces modernes. Ce meuble de rangement industriel premium présente un design industriel robuste avec une construction en acier qui offre une capacité de rangement maximale et un attrait visuel.\n\nFabriqué dans notre atelier de Bekasi depuis 1999, ce meuble de rangement industriel présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente durabilité tout en maintenant une esthétique moderne élégante qui complète tout design d'intérieur industriel ou contemporain.\n\nParfait pour les bureaux, les cafés, les restaurants et les espaces commerciaux, ce meuble de rangement industriel offre des capacités de rangement polyvalentes. Le design industriel crée des solutions de rangement fonctionnelles tout en ajoutant un intérêt visuel à n'importe quel espace.`, metaDescription: 'Porte-Manteau Industriel - Porte-Manteau en Acier | Mobilier Personnalisé | Mangala Living', imageAlt: 'Porte-Manteau Industriel - Porte-Manteau en Acier - Rangement Premium de Mangala Living' },
    ko: { name: '인더스트리얼 코트 랙', caption: '인더스트리얼 코트 랙 - 강철 코트 랙 행거 | Mangala Living', shortCaption: '인더스트리얼 코트 랙 - 코트 랙', description: `Mangala Living의 인더스트리얼 코트 랙은 현대 공간을 위한 완벽한 인더스트리얼 수납 솔루션입니다. 이 프리미엄 인더스트리얼 수납 가구는 최대 수납 용량과 시각적 매력을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 수납 가구는 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 인테리어 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 내구성을 제공합니다.\n\n사무실, 카페, 레스토랑 및 상업 공간에 완벽한 이 인더스트리얼 수납 가구는 다목적 수납 기능을 제공합니다. 인더스트리얼 디자인은 모든 공간에 시각적 흥미를 더하면서 기능적인 수납 솔루션을 만들어냅니다.`, metaDescription: '인더스트리얼 코트 랙 - 강철 코트 랙 | 맞춤 가구 | Mangala Living', imageAlt: '인더스트리얼 코트 랙 - 강철 코트 랙 - Mangala Living의 프리미엄 수납' }
  },
...
Sempurna untuk kantor, workshop, studio, dan ruang komersial, meja kerja industrial ini menyediakan kapasitas kerja yang serbaguna. Desain industrial menciptakan lingkungan kerja profesional sambil menawarkan fungsionalitas praktis untuk tugas harian.`,
    ...
    ar: { name: 'طاولة عمل صناعية', caption: 'طاولة عمل صناعية - مكتب عمل صناعي | Mangala Living', shortCaption: 'طاولة عمل صناعية - مكتب عمل', description: `طاولة العمل الصناعية Meja Kerja Industrial من Mangala Living هي الحل الأمثل لطاولة العمل الصناعية للمكاتب الحديثة والمساحات التجارية. تتميز طاولة العمل الصناعية المميزة هذه بتصميم صناعي قوي مع هيكل فولاذي يوفر أقصى قدر من المتانة والوظائف.\n\nصُنعت في ورشة بيكاسي لدينا منذ عام 1999، تعرض طاولة العمل الصناعية هذه تقنيات لحام متفوقة والاهتمام بالتفاصيل. يوفر هيكل الإطار الفولاذي الصناعي استقرارًا ممتازًا مع الحفاظ على جمالية حديثة أنيقة تكمل أي تصميم مكتب صناعي أو معاصر.\n\nمثالية للمكاتب والورش والاستوديوهات والمساحات التجارية، توفر طاولة العمل الصناعية هذه قدرات عمل متعددة الاستخدامات. يخلق التصميم الصناعي بيئة عمل احترافية مع توفير وظائف عملية للمهام اليومية.`, metaDescription: 'طاولة عمل صناعية - مكتب عمل صناعي | أثاث المكاتب | Mangala Living', imageAlt: 'طاولة عمل صناعية - مكتب عمل صناعي - أثاث مكتب مميز من Mangala Living' },
    zh: { name: '工业工作台', caption: '工业工作台 - 工业工作桌 | Mangala Living', shortCaption: '工业工作台 - 工作桌', description: `Mangala Living的Meja Kerja Industrial工业工作台是现代办公室和商业空间的完美工业工作台解决方案。这款优质工业工作台采用坚固的工业设计和钢结构，提供最大的耐用性和功能性。\n\n自1999年以来在我们位于勿加泗的车间制作，这款工业工作台展示了卓越的焊接技术和对细节的关注。工业钢框架结构提供出色的稳定性，同时保持时尚现代的美学，可以补充任何工业或现代办公室设计。\n\n非常适合办公室、车间、工作室和商业空间，这款工业工作台提供多功能工作能力。工业设计创造了专业的工作环境，同时为日常任务提供实用功能。`, metaDescription: '工业工作台 - 工业工作桌 | 办公家具 | Mangala Living', imageAlt: '工业工作台 - 工业工作桌 - Mangala Living的优质办公家具' },
    ja: { name: 'インダストリアル ワークテーブル', caption: 'インダストリアル ワークテーブル - 工業用ワークデスク | Mangala Living', shortCaption: 'インダストリアル ワークテーブル - ワークデスク', description: `Mangala LivingのMeja Kerja Industrialは、モダンなオフィスと商業空間のための完璧な工業用ワークテーブルソリューションです。このプレミアム工業用ワークテーブルは、最大限の耐久性と機能性を提供する頑丈な工業デザインとスチール構造が特徴です。\n\n1999年以来、ブカシのワークショップで製作されたこの工業用ワークテーブルは、優れた溶接技術と細部へのこだわりを示しています。工業用スチールフレーム構造は、あらゆる工業的または現代的なオフィスデザインを補完する洗練された現代的な美学を維持しながら、優れた安定性を提供します。\n\nオフィス、ワークショップ、スタジオ、商業空間に最適で、この工業用ワークテーブルは多目的な作業機能を提供します。工業デザインは、日常業務のための実用的な機能を提供しながら、プロフェッショナルな作業環境を作り出します。`, metaDescription: 'インダストリアル ワークテーブル - 工業用ワークデスク | オフィス家具 | Mangala Living', imageAlt: 'インダストリアル ワークテーブル - 工業用ワークデスク - Mangala Livingのプレミアムオフィス家具' },
    es: { name: 'Mesa de Trabajo Industrial', caption: 'Mesa de Trabajo Industrial - Escritorio de Trabajo Industrial | Mangala Living', shortCaption: 'Mesa de Trabajo Industrial - Escritorio de Trabajo', description: `La Mesa de Trabajo Industrial Meja Kerja Industrial de Mangala Living es la solución perfecta de mesa de trabajo industrial para oficinas modernas y espacios comerciales. Esta mesa de trabajo industrial premium presenta un diseño industrial robusto con construcción de acero que proporciona la máxima durabilidad y funcionalidad.\n\nElaborada en nuestro taller de Bekasi desde 1999, esta mesa de trabajo industrial muestra técnicas de soldadura superiores y atención al detalle. La construcción del marco de acero industrial ofrece una excelente estabilidad mientras mantiene una estética moderna elegante que complementa cualquier diseño de oficina industrial o contemporáneo.\n\nPerfecta para oficinas, talleres, estudios y espacios comerciales, esta mesa de trabajo industrial proporciona capacidades de trabajo versátiles. El diseño industrial crea un entorno de trabajo profesional mientras ofrece funcionalidad práctica para tareas diarias.`, metaDescription: 'Mesa de Trabajo Industrial - Escritorio de Trabajo Industrial | Mobiliario de Oficina | Mangala Living', imageAlt: 'Mesa de Trabajo Industrial - Escritorio de Trabajo Industrial - Mobiliario de Oficina Premium de Mangala Living' },
    fr: { name: 'Table de Travail Industrielle', caption: 'Table de Travail Industrielle - Bureau de Travail Industriel | Mangala Living', shortCaption: 'Table de Travail Industrielle - Bureau de Travail', description: `La Table de Travail Industrielle Meja Kerja Industrial de Mangala Living est la solution parfaite de table de travail industrielle pour les bureaux modernes et les espaces commerciaux. Cette table de travail industrielle premium présente un design industriel robuste avec une construction en acier qui offre une durabilité et une fonctionnalité maximales.\n\nFabriquée dans notre atelier de Bekasi depuis 1999, cette table de travail industrielle présente des techniques de soudage supérieures et une attention aux détails. La construction du cadre en acier industriel offre une excellente stabilité tout en maintenant une esthétique moderne élégante qui complète tout design de bureau industriel ou contemporain.\n\nParfaite pour les bureaux, les ateliers, les studios et les espaces commerciaux, cette table de travail industrielle offre des capacités de travail polyvalentes. Le design industriel crée un environnement de travail professionnel tout en offrant une fonctionnalité pratique pour les tâches quotidiennes.`, metaDescription: 'Table de Travail Industrielle - Bureau de Travail Industriel | Mobilier de Bureau | Mangala Living', imageAlt: 'Table de Travail Industrielle - Bureau de Travail Industriel - Mobilier de Bureau Premium de Mangala Living' },
    ko: { name: '인더스트리얼 작업 테이블', caption: '인더스트리얼 작업 테이블 - 인더스트리얼 작업 데스크 | Mangala Living', shortCaption: '인더스트리얼 작업 테이블 - 작업 데스크', description: `Mangala Living의 Meja Kerja Industrial은 현대 사무실과 상업 공간을 위한 완벽한 인더스트리얼 작업 테이블 솔루션입니다. 이 프리미엄 인더스트리얼 작업 테이블은 최대 내구성과 기능성을 제공하는 견고한 인더스트리얼 디자인과 강철 구조가 특징입니다.\n\n1999년부터 브카시 워크숍에서 제작된 이 인더스트리얼 작업 테이블은 뛰어난 용접 기술과 세부 사항에 대한 관심을 보여줍니다. 인더스트리얼 강철 프레임 구조는 모든 인더스트리얼 또는 현대적인 사무실 디자인을 보완하는 세련되고 현대적인 미학을 유지하면서 뛰어난 안정성을 제공합니다.\n\n사무실, 작업장, 스튜디오 및 상업 공간에 완벽한 이 인더스트리얼 작업 테이블은 다목적 작업 기능을 제공합니다. 인더스트리얼 디자인은 일상 업무를 위한 실용적인 기능을 제공하면서 전문적인 작업 환경을 만들어냅니다.`, metaDescription: '인더스트리얼 작업 테이블 - 인더스트리얼 작업 데스크 | 사무실 가구 | Mangala Living', imageAlt: '인더스트리얼 작업 테이블 - 인더스트리얼 작업 데스크 - Mangala Living의 프리미엄 사무실 가구' }
  }
}
