...
export const STEEL_SERVICES: SteelService[] = [
  ...
  },
  {
    ...
    icon: '🛢️',
    cluster: 'residential',
    keywords: ['menara tangki air', 'toren air besi', 'menara toren bekasi', 'rangka tangki air besi siku', 'menara toren air minimalis'],
    metaTitle: {
      en: 'Custom Steel Water Tank Tower Bekasi | Menara Tangki Air | Mangala Living',
      id: 'Jasa Pembuatan Menara Tangki Air Besi Custom Bekasi | Mangala Living',
    },
    metaDescription: {
      en: 'Custom steel water tank towers for homes and commercial buildings. Heavy-duty angle bar and hollow steel construction. Bekasi workshop, free consultation.',
      id: 'Jasa pembuatan menara tangki air (toren) besi siku & hollow custom di Bekasi. Konstruksi kokoh, tahan beban & angin, finishing anti karat.',
    },
    unsplashQuery: 'water tank tower steel construction',
    translations: {
      en: {
        name: 'Water Tank Tower',
        shortDesc: 'Sturdy steel water tank towers for residential & commercial use',
        longDesc: 'Custom steel water tank towers (menara toren air) engineered to support heavy water loads safely. We fabricate using heavy-duty steel angle bars, square hollow tubes, and solid base plates, finished with anti-rust primer and powder coating.',
        heroTitle: 'Custom Steel Water Tank Tower — Bekasi Workshop',
        heroSubtitle: 'Engineered for maximum stability, load capacity, and weather resistance. Single and multi-tank tower designs.',
        materialTitle: 'Available Specifications',
        materials: ['Angle Bar (Siku 4x4, 5x5, 6x6)', 'Hollow Steel Framework', 'Chequered Plate Base', 'Ladder with Guard Cage', 'Anti-Rust Primer & Powder Coat'],
        processTitle: 'Our Process',
        process: ['Tank capacity & height assessment', 'Structural load calculation', 'Steel fabrication in Bekasi', 'On-site anchoring & erection', 'Safety check & handover'],
        faqs: [
          { q: 'What height can you build for a water tank tower?', a: 'Standard tower heights are 2m, 3m, 4m, and up to 6m for maximum water pressure.' },
          { q: 'Is it safe against strong winds and earthquakes?', a: 'Yes. All our towers use diagonal bracing and anchor bolts welded into deep concrete foundations.' },
        ],
      },
      id: {
        name: 'Menara Tangki Air (Toren)',
        shortDesc: 'Menara tangki air besi siku & hollow kokoh tahan beban',
        longDesc: 'Jasa pembuatan menara tangki air (toren) besi custom yang direkayasa untuk menopang beban air ribuan liter secara aman. Kami menggunakan siku baja tebal, hollow besi, dan plat dasar kokoh dengan finishing anti karat.',
        heroTitle: 'Menara Tangki Air Besi Custom — Workshop Bekasi',
        heroSubtitle: 'Konstruksi kokoh, aman, dan tahan cuaca. Menara toren single maupun multi-tangki untuk rumah dan industri.',
        materialTitle: 'Pilihan Spesifikasi',
        materials: ['Besi Siku (4x4, 5x5, 6x6 cm)', 'Rangka Hollow Besi', 'Plat Bordes Dudukan Toren', 'Tangga Akses Monyet', 'Cat Anti Karat & Powder Coat'],
        processTitle: 'Proses Pengerjaan',
        process: ['Penilaian kapasitas toren & tinggi', 'Kalkulasi beban struktural', 'Fabrikasi baja di workshop Bekasi', 'Pengangkuran & ereksi di lokasi', 'Inspeksi keamanan & serah terima'],
        faqs: [
          { q: 'Berapa tinggi standar menara tangki air?', a: 'Tinggi standar adalah 2m, 3m, 4m, hingga 6m untuk gravitasi tekanan air maksimal.' },
          { q: 'Apakah aman dari angin kencang?', a: 'Sangat aman. Menara dilengkapi bracing silang diagonal dan diangkur ke pondasi beton bertulang.' },
        ],
      },
    },
  },
  {
    ...
    icon: '🏢',
    cluster: 'residential',
    keywords: ['pintu henderson', 'pintu henderson besi', 'pintu garasi henderson bekasi', 'pintu lipat henderson', 'pintu geser henderson'],
    metaTitle: {
      en: 'Custom Henderson Steel Garage Door Bekasi | Mangala Living',
      id: 'Jasa Pembuatan Pintu Henderson Besi Custom Bekasi | Mangala Living',
    },
    metaDescription: {
      en: 'Custom henderson sliding and folding steel garage doors for residential and commercial buildings. Heavy-duty track systems, powder-coated finish. Bekasi workshop.',
      id: 'Jasa pembuatan pintu henderson besi garasi sliding & lipat custom di Bekasi. Roda & rel heavy duty, finishing powder coat, kokoh & elegan.',
    },
    unsplashQuery: 'steel garage sliding door modern home',
    translations: {
      en: {
        name: 'Henderson Steel Garage Door',
        shortDesc: 'Heavy-duty henderson sliding & folding garage doors',
        longDesc: 'Premium henderson-style steel garage doors with smooth sliding and folding track systems. Designed for residential garages, commercial storehouses, and showrooms requiring max opening clearance.',
        heroTitle: 'Henderson Steel Garage Door — Custom Fabrication',
        heroSubtitle: 'Sleek, heavy-duty sliding & folding steel doors for garages and shopfronts. Built with top-grade steel and track mechanisms.',
        materialTitle: 'Available Configurations',
        materials: ['Henderson Sliding Gate System', 'Henderson Bi-Fold System', 'Insulated Panel Options', 'Louver / Ventilation Slats', 'Powder Coat Finish (multiple colors)'],
        processTitle: 'Our Process',
        process: ['Opening width & height survey', 'Track system selection', 'Fabrication in Bekasi', 'Track & wheel mounting', 'Door alignment & handover'],
        faqs: [
          { q: 'Does a Henderson door slide smoothly?', a: 'Yes. We use original heavy-duty ball-bearing roller tracks for effortless sliding.' },
        ],
      },
      id: {
        name: 'Pintu Henderson (Garasi)',
        shortDesc: 'Pintu besi garasi sistem henderson geser & lipat heavy duty',
        longDesc: 'Pintu besi garasi gaya henderson premium dengan sistem rel gantung geser dan lipat yang halus. Dirancang untuk garasi hunian, ruko, dan showroom yang membutuhkan bukaan maksimal.',
        heroTitle: 'Pintu Henderson Besi Custom — Garasi & Ruko',
        heroSubtitle: 'Elegan, kokoh, dan mudah digeser. Pintu garasi henderson sliding & lipat dari workshop Bekasi.',
        materialTitle: 'Pilihan Konfigurasi',
        materials: ['Sistem Henderson Sliding', 'Sistem Henderson Bi-Fold / Lipat', 'Opsi Panel Insulasi / Double Sheet', 'Jalusi Ventilasi Air Flow', 'Finishing Powder Coat (bebas warna)'],
        processTitle: 'Proses Pengerjaan',
        process: ['Survey lebar & tinggi garasi', 'Pemilihan sistem rel & mekanis', 'Fabrikasi di workshop Bekasi', 'Pemasangan rel & roda gantung', 'Setel kelurusan & serah terima'],
        faqs: [
          { q: 'Apakah pintu henderson mudah dorongnya?', a: 'Sangat ringan dan halus karena menggunakan roda bearing heavy-duty berkualitas tinggi.' },
        ],
      },
    },
  },
  {
    ...
    icon: '🛡️',
    cluster: 'residential',
    keywords: ['pintu kasa nyamuk', 'pintu expanda besi', 'pintu tralis kasa nyamuk', 'pintu keamanan nyamuk bekasi'],
    metaTitle: {
      en: 'Custom Steel Mesh Door (Expanda) Bekasi | Mangala Living',
      id: 'Jasa Pembuatan Pintu Kasa Nyamuk Besi (Expanda) Bekasi | Mangala Living',
    },
    metaDescription: {
      en: 'Custom steel security mesh doors (expanda) with stainless insect screen. Air circulation with full security. Bekasi workshop.',
      id: 'Jasa pembuatan pintu kasa nyamuk besi (expanda) dan teralis pintu custom di Bekasi. Sirkulasi udara segar dengan keamanan maksimal.',
    },
    unsplashQuery: 'steel mesh door entrance security',
    translations: {
      en: {
        name: 'Security Mesh Door (Expanda)',
        shortDesc: 'Steel mesh security doors with stainless insect screen',
        longDesc: 'Double-duty security mesh doors providing fresh air ventilation while keeping insects out and intruders away. Built with sturdy steel frames, expanded metal mesh, and fine stainless insect screens.',
        heroTitle: 'Steel Mesh Security Door — Expanda',
        heroSubtitle: 'Enjoy fresh air with complete security and insect protection. Dual lock systems, powder-coated finish.',
        materialTitle: 'Door Specifications',
        materials: ['Steel Frame Grid', 'Expanded Metal Mesh', 'Stainless Steel Insect Mesh', 'Multi-point Deadbolt Lock', 'Powder Coat Finish'],
        processTitle: 'Our Process',
        process: ['On-site door frame measurement', 'Mesh & lock selection', 'Fabrication in Bekasi', 'Installation & lock fitting'],
        faqs: [
          { q: 'Can the insect mesh be replaced if damaged?', a: 'Yes. The stainless insect mesh is easily replaceable without replacing the steel frame.' },
        ],
      },
      id: {
        name: 'Pintu Kasa Nyamuk (Expanda)',
        shortDesc: 'Pintu teralis besi kasa nyamuk stainless anti maling & serangga',
        longDesc: 'Pintu besi double fungsional yang memberikan sirkulasi udara segar sekaligus mencegah masuknya serangga dan gangguan keamanan. Dibuat dari rangka besi hollow, kawat expanda, dan kasa nyamuk stainless steel.',
        heroTitle: 'Pintu Kasa Nyamuk Besi — Expanda Security',
        heroSubtitle: 'Sirkulasi udara segar dengan perlindungan total dari nyamuk & keamanan rumah. Finishing powder coat.',
        materialTitle: 'Spesifikasi Pintu',
        materials: ['Rangka Besi Hollow', 'Kawat Expanda Baja', 'Kasa Nyamuk Stainless Steel', 'Kunci Double Deadbolt', 'Finishing Powder Coat'],
        processTitle: 'Proses Pengerjaan',
        process: ['Pengukuran kusen pintu di lokasi', 'Pemilihan kawat & jenis kunci', 'Fabrikasi di workshop Bekasi', 'Pemasangan & pengepasan kunci'],
        faqs: [
          { q: 'Apakah kasa nyamuk bisa diganti jika rusak?', a: 'Bisa. Kasa nyamuk stainless dipasang dengan lis yang mudah diganti tanpa perlu mengganti rangka besinya.' },
        ],
      },
    },
  },
  {
    ...
    icon: '🌀',
    cluster: 'residential',
    keywords: ['tangga putar besi', 'tangga putar minimalis', 'harga tangga putar bekasi', 'tangga spiral besi', 'tangga putar jemuran'],
    metaTitle: {
      en: 'Custom Steel Spiral Staircase Bekasi | Tangga Putar | Mangala Living',
      id: 'Jasa Pembuatan Tangga Putar Besi Minimalis Bekasi | Mangala Living',
    },
    metaDescription: {
      en: 'Custom steel spiral staircases (tangga putar) for compact spaces, balconies, and rooftop drying areas. Bekasi workshop, factory-direct pricing.',
      id: 'Jasa pembuatan tangga putar besi minimalis custom di Bekasi. Solusi hemat tempat untuk lantai 2, loteng, dan area jemuran. Konstruksi kokoh & aman.',
    },
    unsplashQuery: 'steel spiral staircase interior design',
    translations: {
      en: {
        name: 'Spiral Steel Staircase (Tangga Putar)',
        shortDesc: 'Space-saving spiral staircases for rooftops & tight spaces',
        longDesc: 'Compact spiral staircases ideal for access to rooftops, drying areas, and mezzanine floors where space is limited. Fabricated with central steel pipe columns, anti-slip treads, and continuous safety handrails.',
        heroTitle: 'Spiral Steel Staircase — Space Saving Access',
        heroSubtitle: 'Maximise floor space with custom steel spiral stairs. Ideal for service areas, balconies, and rooftop decks.',
        materialTitle: 'Stair Specifications',
        materials: ['Central Column Steel Pipe (4" thick)', 'Chequered Plate Anti-Slip Treads', 'Round Pipe Safety Railing', 'Powder Coat Finish'],
        processTitle: 'Our Process',
        process: ['Vertical height & diameter survey', 'Custom spiral CAD layout', 'Fabrication in Bekasi', 'Assembly & installation'],
        faqs: [
          { q: 'What is the minimum diameter needed for a spiral staircase?', a: 'Minimum diameter is 120cm, but 140–150cm is recommended for comfortable everyday walking.' },
        ],
      },
      id: {
        name: 'Tangga Putar Besi',
        shortDesc: 'Tangga putar besi hemat tempat untuk jemuran & lantai 2',
        longDesc: 'Tangga putar besi compact yang sangat efisien untuk akses ke rooftop, tempat jemuran, dan lantai mezzanine di mana ruang lantai terbatas. Dibuat dari tiang poros pipa besi tebal, anak tangga bordes anti-selip, dan railing pengaman.',
        heroTitle: 'Tangga Putar Besi Minimalis — Hemat Tempat',
        heroSubtitle: 'Maksimalkan ruang lantai Anda dengan tangga putar besi custom. Solusi ideal untuk balkon, lantai 2, dan akses ruko.',
        materialTitle: 'Spesifikasi Tangga',
        materials: ['Tiang Poros Pipa Besi (4 inci tebal)', 'Anak Tangga Plat Bordes Anti-Slip', 'Railing Pengaman Pipa Bulat', 'Finishing Powder Coat'],
        processTitle: 'Proses Pengerjaan',
        process: ['Survey tinggi lantai & diameter ruang', 'Layout CAD spiral custom', 'Fabrikasi di workshop Bekasi', 'Perakitan & pemasangan'],
        faqs: [
          { q: 'Berapa diameter minimal untuk tangga putar?', a: 'Diameter minimal adalah 120cm, tetapi 140–150cm direkomendasikan untuk kenyamanan melangkah.' },
        ],
      },
    },
  },
  {
    slug: 'tukang-las-panggilan',
    icon: '🛠️',
    cluster: 'industrial',
    keywords: ['tukang las panggilan bekasi', 'jasa las terdekat 24 jam', 'bengkel las panggilan cibubur', 'perbaikan pagar kanopi besi', 'servis las listrik terdekat'],
    metaTitle: {
      en: 'Call-Out Welding & Repair Service Bekasi 24/7 | Mangala Living',
      id: 'Jasa Tukang Las Panggilan Terdekat Bekasi & Jabodetabek 24 Jam | Mangala Living',
    },
    metaDescription: {
      en: 'Nearby 24/7 call-out welding repair service in Bekasi, Jakarta, Cibubur, Cikarang. Repair canopy, broken fence hinges, steel gate, and custom welding.',
      id: 'Jasa tukang las panggilan terdekat 24 jam di Bekasi, Jakarta, Cibubur, Depok, Cikarang. Perbaikan kanopi, pagar engsel patah, rel pintu, dan las perbaikan.',
    },
    unsplashQuery: 'welder working with sparks on site',
    translations: {
      en: {
        name: 'Call-Out Welding & Repair',
        shortDesc: 'Nearby 24/7 on-site welding repair for gates, fences & canopies',
        longDesc: 'Prompt mobile welding service directly at your doorstep. We handle urgent repairs for broken fence hinges, sagging sliding gate tracks, rusted canopy supports, re-welding structural components, and custom on-site modifications.',
        heroTitle: 'Call-Out Mobile Welding & Repair Service',
        heroSubtitle: 'Fast, reliable mobile welders at your service across Jabodetabek. Emergency repairs and custom modifications on site.',
        materialTitle: 'Services Handled',
        materials: ['Fence Hinge & Latch Repair', 'Sliding Gate Track Adjustment', 'Canopy Leak & Frame Repair', 'Structural Re-welding', 'On-Site Fabrication'],
        processTitle: 'Our Process',
        process: ['Call or WhatsApp issue details & photo', 'Fast technician dispatch', 'On-site repair & welding', 'Testing & payment'],
        faqs: [
          { q: 'How fast can a welder arrive?', a: 'For Bekasi, Cibubur, and Cikarang areas, we can arrive within 1–2 hours of confirmation.' },
        ],
      },
      id: {
        name: 'Tukang Las Panggilan Terdekat',
        shortDesc: 'Jasa tukang las panggilan terdekat 24 jam untuk perbaikan pagar & kanopi',
        longDesc: 'Layanan tukang las panggilan cepat langsung ke lokasi Anda. Kami menangani perbaikan darurat untuk engsel pagar patah, rel pintu garasi macet/turun, rangka kanopi bocor/karat, las ulang struktur besi, dan modifikasi di tempat.',
        heroTitle: 'Jasa Tukang Las Panggilan — Terdekat & Siaga',
        heroSubtitle: 'Tukang las listrik berpengalaman siap datang ke rumah Anda di wilayah Jabodetabek. Perbaikan cepat & rapi.',
        materialTitle: 'Layanan Perbaikan',
        materials: ['Perbaikan Engsel & Grendel Pagar', 'Perbaikan Rel & Roda Pintu Sliding', 'Servis Rangka Kanopi & Atap', 'Las Ulang Sambungan Besi Patah', 'Modifikasi Besi di Tempat'],
        processTitle: 'Proses Pengerjaan',
        process: ['Telepon / WA foto & info kerusakan', 'Pengiriman teknisi ke lokasi Anda', 'Perbaikan & pengelasan di tempat', 'Testing & pembayaran'],
        faqs: [
          { q: 'Berapa cepat teknisi las bisa datang?', a: 'Untuk area Bekasi, Cibubur, dan Cikarang, teknisi kami bisa tiba dalam 1–2 jam setelah konfirmasi.' },
        ],
      },
    },
  },
