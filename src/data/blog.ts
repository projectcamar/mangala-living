...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    "id": 298,
    "slug": "teakwood-furniture-mangala-living-indonesian-heritage",
    "title": "柚木家具的魅力",
    "category": "Tips and Trick",
    "excerpt": "柚木家具的独特魅力，芒果生活带您探索印尼传统家具",
    "image": "https://images.unsplash.com/photo-1516987690414-5cf412ae5997?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU2ODd8MHwxfHNlYXJjaHwxfHx0ZWFrJTIwd29vZCUyMGRpbmluZyUyMHRhYmxlJTIwaW5kb25lc2lhfGVufDB8MHx8fDE3Njk4NTIwNTB8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "date": "2026-01-31 09:33",
    "author": "Helmi Ramdan",
    "customContent": {
      "introduction": "印尼传统家具中，柚木家具是最具代表性的之一。芒果生活作为一家具有25年历史的工业家具制造商，致力于将柚木家具的独特魅力带到您的家中。柚木家具不仅美观，而且具有耐用和环保的特点，成为现代家庭的首选。 <br> 本文将为您介绍柚木家具的独特魅力，并提供选择和保养柚木家具的实用贴士。",
      "keyPoints": [
        "柚木家具的独特魅力",
        "选择合适的柚木家具",
        "保养柚木家具的方法"
      ...
      "sections": [
        {
          "heading": "为什么选择柚木家具？",
          "content": "柚木家具具有独特的美感和耐用性，是现代家庭的首选。柚木是一种天然的、可持续的材料，具有抗腐蚀和抗虫蛀的特点。 <strong>芒果生活</strong> 的柚木家具采用高质量的柚木，经过精心设计和制作，确保每一件家具都具有独特的魅力和耐用性。 <br> 除了美观和耐用性，柚木家具还具有环保的特点。柚木是一种可持续的材料，采收和加工过程对环境的影响很小。因此，选择柚木家具不仅是选择了一件美观的家具，也是支持环保和可持续发展的行为。"
        },
        {
          "heading": "选择合适的柚木家具",
          "content": "选择合适的柚木家具需要考虑几个因素，包括家具的大小、形状、颜色和风格。 <em>芒果生活</em> 提供各种类型的柚木家具，从现代风格到传统风格，满足不同客户的需求。 <br> 选择柚木家具时，需要注意家具的质量和材料。 <strong>芒果生活</strong> 的柚木家具采用高质量的柚木，经过精心设计和制作，确保每一件家具都具有独特的魅力和耐用性。"
        },
        {
          "heading": "保养柚木家具的方法",
          "content": "保养柚木家具需要定期清洁和维护。 <em>芒果生活</em> 推荐使用软布和温和的清洁剂清洁柚木家具，避免使用强烈的化学品或磨砂工具。 <br> 除了清洁，保养柚木家具还需要避免直接暴露于阳光下和潮湿环境中。 <strong>芒果生活</strong> 的柚木家具经过特殊处理，具有抗腐蚀和抗虫蛀的特点，但仍需要定期维护和保养。"
        }
      ],
      "conclusion": "柚木家具是现代家庭的首选，具有独特的美感和耐用性。 <strong>芒果生活</strong> 作为一家具有25年历史的工业家具制造商，致力于将柚木家具的独特魅力带到您的家中。选择 <em>芒果生活</em> 的柚木家具，不仅是选择了一件美观的家具，也是支持环保和可持续发展的行为。欢迎访问 <strong>芒果生活</strong> 的网站，探索更多的柚木家具产品和实用贴士。"
    }
  },
  {
    "id": 299,
    "slug": "indonesian-heritage-teakwood-furniture-tips",
    "title": "인도네시아 전통 티크 나무 가구",
    "category": "Tips and Trick",
    "excerpt": "망갈라 리빙의 인도네시아 전통 티크 나무 가구",
    "image": "https://images.unsplash.com/photo-1667992403195-d2241a40ca2d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU2ODd8MHwxfHNlYXJjaHwxfHxpbmRvbmVzaWFuJTIwdGVhayUyMHdvb2QlMjBmdXJuaXR1cmUlMjBkZXNpZ258ZW58MHwwfHx8MTc2OTg1MjA2N3ww&ixlib=rb-4.1.0&q=80&w=1080",
    "date": "2026-01-31 09:34",
    "author": "Helmi Ramdan",
    "customContent": {
      "introduction": "인도네시아는 자연이 아름다운 나라로, 전통적인 티크 나무 가구는 인도네시아의 문화를 대표합니다. 망갈라 리빙은 25년 이상의 경험과 1000개 이상의 프로젝트를 통해 인도네시아의 전통적인 티크 나무 가구를 제공합니다. 이 글에서는 티크 나무 가구의 특징과 망갈라 리빙의 티크 나무 가구를 사용하는 방법에 대한 팁을 제공합니다.",
      "keyPoints": [
        "티크 나무 가구의 특징",
        "망갈라 리빙의 티크 나무 가구",
        "티크 나무 가구 사용 팁"
      ...
      "sections": [
        {
          "heading": "티크 나무 가구의 특징",
          "content": "티크 나무는 내구성과 아름다움으로 알려져 있습니다. <strong>내구성</strong>은 티크 나무 가구의 가장 큰 특징 중 하나입니다. 티크 나무는 물과 자외선에 강하기 때문에, 장기간 동안 사용할 수 있습니다. 또한, 티크 나무는 <em>아름다운 무늬</em>를 가지고 있습니다. 이 무늬는 티크 나무 가구의 고유한 매력을 제공합니다. 망갈라 리빙은 티크 나무 가구를制作하여, 고객들에게 최고의 품질을 제공합니다."
        },
        {
          "heading": "망갈라 리빙의 티크 나무 가구",
          "content": "망갈라 리빙은 25년 이상의 경험과 1000개 이상의 프로젝트를 통해 인도네시아의 전통적인 티크 나무 가구를 제공합니다. <strong>고객 중심</strong>의 서비스로, 고객들의 필요를 이해하고, 최고의 티크 나무 가구를 제공합니다. 망갈라 리빙의 티크 나무 가구는 <em>고품질</em>의 재료와, <em>정교한 제작 기술</em>로 만들어집니다. 이로써, 고객들에게 최고의 티크 나무 가구를 제공할 수 있습니다. <br> 망갈라 리빙의 티크 나무 가구는 카페, 레스토랑, 호텔, 오피스 등 다양한 공간에서 사용할 수 있습니다."
        },
        {
          "heading": "티크 나무 가구 사용 팁",
          "content": "티크 나무 가구를 사용할 때, 몇 가지 팁을 알아두면, 더 오래 사용할 수 있습니다. <strong>정기적인 청소</strong>는 티크 나무 가구의 중요한 부분입니다. 티크 나무 가구를 청소할 때, 부드러운 천과 물을 사용하여, 티크 나무의 표면을 닦아주세요. 또한, <em>직사광선</em>을 피하는 것이 중요합니다. 직사광선은 티크 나무의 색을 변색시킬 수 있습니다. <br> 망갈라 리빙의 티크 나무 가구는 내구성과 아름다움으로 만들어졌습니다. 따라서, 티크 나무 가구를 사용할 때, 이러한 팁을 따라, 더 오래 사용할 수 있습니다."
        }
      ],
      "conclusion": "망갈라 리빙의 인도네시아 전통 티크 나무 가구는 고품질과 내구성으로 만들어졌습니다. 티크 나무 가구를 사용할 때, 몇 가지 팁을 알아두면, 더 오래 사용할 수 있습니다. 망갈라 리빙은 고객들에게 최고의 티크 나무 가구를 제공하고, 25년 이상의 경험과 1000개 이상의 프로젝트를 통해, 고객들의 필요를 이해하고 있습니다. 망갈라 리빙의 티크 나무 가구를 사용하여, 공간을 아름답게 만드세요."
    }
  }
]
