...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        <title>Mangala Living - XML Sitemap Index</title>
      ...
      <body>
        <div class="container">
          <header>
            <h1><span class="brand">MANGALA LIVING</span> XML Sitemap Index</h1>
            <p class="subtitle">Industrial Furniture Custom - Bekasi, Indonesia</p>
          </header>
          ...
          <footer>
            <p>Generated by Mangala Living Sitemap Generator</p>
            <p style="margin-top: 10px;">
              <a href="https://mangala-living.com" target="_blank">← Back to Mangala Living</a>
            </p>
          </footer>
        </div>
      </body>
